      ...
      <div class="col-md-8 col-md-offset-2 col-xs-12">
        <div class="mainheading">
          <h1 class="posttitle mb-0 pb-0">
            <div>{{ title }}</div>
            <small v-if="subtitle" class="text-muted" style="font-size: 0.7em">
              {{ subtitle }}
            </small>
          </h1>
