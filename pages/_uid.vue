      ...
      <div class="row">
        ...
        <div class="col-md-2 col-xs-12">
          <div class="share">
            ...
            <ul>
              <li>
                <a target="_blank" :href="'https://twitter.com/home?status=' + fullUrl">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
          <div
            v-if="false"
            class="cover-image"
            style="background-image:url('https://jpnarowski.com/wp-content/uploads/2015/07/11406966_10153324153274845_4885584158810164648_n.jpg');"
          />

          <div class="mainheading">
            <h1 class="posttitle mb-0 pb-0">
              <div>{{ title }}</div>
              <small v-if="subtitle" class="text-muted" style="font-size: 0.7em">{{ subtitle }}</small>
            </h1>
          </div>

          <!-- Begin Post Content -->
          <div class="article-post">
            <img v-if="featuredImage" class="featured-image img-fluid" :src="featuredImage.url" alt />
            <post-content :body="body" :slices="slices"></post-content>
          </div>
          <!-- End Post Content -->
